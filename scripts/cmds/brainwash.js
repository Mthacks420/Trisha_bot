    ...
    onStart: async function ({ api, event, usersData }) {
        ...
        try {
            ...
            const lines = [
                ...
                `🧼 সাবান আর হুইল পাউডার দিয়ে ${name}-এর মগজ ধোলাই চলছে... উফ্! কত ময়লা! thuuu 🤧🤢`,
            ...
            await api.sendMessage(`🔄 ${name}-নড়াচড়া করো না, তোমার ব্রেইনওয়াশ করা হচ্ছে 😗`, threadID, messageID);
